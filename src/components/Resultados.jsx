        ...
        <div id="resultados" className="min-h-screen bg-gray-900 flex flex-col items-center px-3 space-y-20 py-12">
            ...
            <div className="grid grid-cols-2 max-lg:grid-cols-1 justify-items-center items-center gap-12">
                <div className="space-y-12 justify-items-center items-center">
                    ...
                    <p className="text-gray-50 text-center">Os resultados da ninfoplastia são visíveis após a recuperação inicial, com a evolução completa ocorrendo em até 6 meses.</p>
                    <ul className="text-gray-50 space-y-5">
                        <li className="relative before:content-['✔']">Conforto e estética aprimorados</li>
                        <li className="relative before:content-['✔']">Forma e simetria dos pequenos lábios corrigidas</li>
                ...
                <div className="grid grid-cols-1 max-lg:grid-cols-2 gap-4 items-center justify-items-center">
                    ...
                    <div className="cardResultados">
                        ...
                        <p className="text-gray-400 text-xl max-lg:text-lg">Dias de Repouso Relativo</p>
                    </div>

                    <div className="cardResultados">
                        <h2 className="cardNum text-gray-100 text-5xl font-semibold">6</h2>
                        <p className="text-gray-400 text-xl max-lg:text-lg ">Semanas para Retomar Atividades</p>
                    </div>
                </div>
            </div>
