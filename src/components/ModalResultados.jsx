            ...
            <div className="text-white p-6 rounded-lg w-full h-full">
              ...
              <div className="bg-slate-800 space-y-8 rounded-lg">
                ...
                <div className="flex justify-between border-b border-gray-700 py-2">
                  ...
                  <span className="text-right">Redução do inchaço e desconforto, com melhora gradual da região íntima</span>
                </div>
                <div className="flex justify-between border-b border-gray-700 py-2">
                  <span>1-2 meses</span>
                ...
                <div className="flex justify-between py-2">
                  <span>3-6 meses</span>
                  <span className="text-right">Resultados finais com cicatrização completa e contorno harmonioso</span>
                </div>
              </div>
            </div>
          </div>
